...
La première étape consiste à créer un compte AWS puis se connecter à  la console AWS Management. Une fois authentifié recherché et lancer le service Lamba pour ensuite cliquez sur créer une  fonction.
